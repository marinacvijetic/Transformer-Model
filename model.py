...
class PositionalEncoding(nn.Module):
    # In constructor, we add:
    # d_model (size of the vector that the PositionalEncoding should be)
    # seq_len (max length of the sentence) because we need to create one vector for each position
    # dropout (to make model less overfeed)
    def __init__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        # If we want the tensor to be saved with the file
...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        # Make sure d_model is dividable by h
...
# N - number of layers (num of encoder&decoder blocks); h - number of heads
